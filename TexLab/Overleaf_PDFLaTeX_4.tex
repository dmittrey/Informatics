...
%Added in file 4:
\usepackage{tikz} % package for graphical objects
...
!!! YOU SHOULD SUBSTITUTE THIS TEXT WITH THE EXPRESSION ACCORDING TO PERSONAL TASK 2 !!!

\newpage
\section{Graphic elements}

This is quite complex area. But it allows to create points, lines, shapes, diagrams.
